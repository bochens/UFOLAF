...
UFOLAF was created to support easier integration with Icescopy, another image-analysis software package for ice nucleation freezing-array experiments, while remaining licensed under the GNU Affero General Public License v3.0.
